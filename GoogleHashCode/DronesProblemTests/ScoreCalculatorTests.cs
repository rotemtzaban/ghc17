...
namespace DronesProblemTests
{
	...
	public class ScoreCalculatorTests
	{
		...
		public void ReadOutputFileTest()
		{
			...
			Assert.AreEqual(1u, loadCommand.Drone.Index);
			...
			Assert.AreEqual(1u, deliverCommand.Drone.Index);
