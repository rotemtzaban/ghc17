...
{
    public abstract class PrinterBase<TOutput> : IPrinter<TOutput>
    {
        ...
        public abstract void PrintToFile(TOutput result, string outputPath);

        public abstract void PrintToConsole(TOutput result);
    }
}
